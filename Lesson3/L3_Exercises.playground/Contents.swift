...
admitted.append(contentsOf: [waitingList.removeFirst(), waitingList.removeFirst()])
print(admitted)
//: ### Exercise 7
...
let otherDict = ["Anchovies": false, "Coconut": true, "Cilantro": true, "Liver": false]
...
presidentialPetsDict["George W. Bush"] = presidentialPetsDict.removeValue(forKey: "George Bush")
print(presidentialPetsDict)
//: ### Exercise 11
